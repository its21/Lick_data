...
#change x = 3 and y = 3 if you want to change the field of view! 3x3 arcmin
image_url = 'http://archive.eso.org/dss/dss/image?ra=%.5f&dec=%.5f&x=3&y=3&Sky-Survey=DSS1&mime-type=download-fits' % ((ra), (dec))
